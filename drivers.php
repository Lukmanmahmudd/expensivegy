<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $stmt = $conn->prepare("INSERT INTO drivers (driver_name, license_number, contact_number) VALUES (?, ?, ?)");
        $stmt->bind_param("sss", $driver_name, $license_number, $contact_number);
...
<head>
    ...
    <style>
        ...
        .form-section form .form-group input[type="submit"] {
            ...
            border-radius: 5px;
            width: 100%;
            display: block; /* Ensures button spans the full width */
